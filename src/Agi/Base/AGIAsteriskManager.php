...
namespace App\Agi\Base;
 /**
  * AGIAsteriskManager.php : PHP Asterisk Manager functions
  * Website: http://phpagi.sourceforge.net
  *
  * $Id: AGIAsteriskManager.php,v 1.10 2005/05/25 18:43:48 pinhole Exp $
  *
  ...
  */
  class AGIAsteriskManager
  {
    ...
    */
    function AGIAsteriskManager($config=NULL, $optconfig=array())
    {
      // load config
    ...
    */
    function process_event($parameters)
    {
      ...
      /**
       * @param AGI $pagi
       * @return AGIAsteriskManager
       */
      public function setPagi(AGI $pagi): AGIAsteriskManager
      {
          $this->pagi = $pagi;
          return $this;
      }
